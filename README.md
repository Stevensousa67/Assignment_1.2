...
and contains a collection of 45,716 data entries. Each entry has information about a single meteorite landing on Earth. 
...
year) and the upper limit (ending year). The program will then ask the user if they'd like the filtered results to be
